...
namespace SudisIm.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager,IOwinContext context )
        {
            UserManager = userManager;
            SignInManager = signInManager;
            this.context = HttpContext.GetOwinContext();
        }
        ...
        public SignInManager<ApplicationUser, string> SignInManager
        {
            get
            {
                return _signInManager ?? new SignInManager<ApplicationUser,string>(UserManager, HttpContext.GetOwinContext().Authentication);
            }
            private set 
            { 
                ...
                return _userManager ??
                       new UserManager<ApplicationUser>(
                           new UserStore<ApplicationUser>(NHibernateHelper.Instance
                               .OpenSession())); //HttpContext.GetOwinContext().GetUserManager<ApplicationUserManager>();
            }
            private set{
                _userManager = value;
            }
