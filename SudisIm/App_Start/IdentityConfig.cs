...
namespace SudisIm
{
    ...
    // Configure the application applicationUser manager used in this application. UserManager is defined in ASP.NET Identity and is used by the application.
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        {
            return new ApplicationSignInManager(NHibernateHelper.userManager, context.Authentication);
        }
    }
}
